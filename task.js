 ...
 */
let users = [
    { name: "Oji", age: 10, major: "SI" },
    { name: "Febryan", age: 8, major: "TI" },
    { name: "Irfan", age: 7, major: "Marketing" },
    { name: "Ayu", age: 18, major: "Manajement" },
    { name: "Iqbal", age: 20, major: "Disainer" }
